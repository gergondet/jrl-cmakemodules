...
MACRO(DISTCHECK_SETUP)
  IF(UNIX)
    ...
    SET(DISTCHECK_TARGET "distcheck")
    IF(JRL_META_PACKAGE)
      STRING(APPEND DISTCHECK_TARGET "-${PROJECT_NAME}")
    ENDIF()
    ADD_CUSTOM_TARGET(${DISTCHECK_TARGET}
      COMMAND
    ...
    ADD_DEPENDENCIES(${DISTCHECK_TARGET} ${DISTDIR_TARGET})
  ELSE()
